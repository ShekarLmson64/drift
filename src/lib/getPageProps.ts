...
import { getPageQuery } from "./sanityQueries"

const getServerSideProps = async (
  context: any,
  path: any,
) => {
  const isMobileInitial = /(Android|BlackBerry|iPhone|iPad|iPod|Opera Mini|IEMobile|WPDesktop)/i.test(context.req.headers["user-agent"] || "")
